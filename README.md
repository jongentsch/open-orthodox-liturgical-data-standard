...
An application may use these layers to maintain a broad research corpus and
collaborative workspaces. A published research digest is a candidate pack
profile; live account, permission, comment, and editorial state is not part of
